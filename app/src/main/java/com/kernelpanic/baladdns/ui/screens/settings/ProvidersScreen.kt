...
import com.kernelpanic.baladdns.ui.components.settings.ProviderSelection
import com.kernelpanic.baladdns.ui.components.settings.ProviderPresetSelection
import com.kernelpanic.baladdns.ui.components.settings.ProviderSelectionAction
...
private fun ProviderPresetOptionsScreen(
    ...
    onBack: () -> Unit,
    onPresetSelected: (com.kernelpanic.baladdns.data.provider.ResolverPresetId) -> Unit,
) {
