...
import com.kernelpanic.baladdns.data.dns.DnsConfigurationRepository
...
import com.kernelpanic.baladdns.data.provider.ProviderSelectionUpdateResult
...
import com.kernelpanic.baladdns.services.AdnsTileService
...
class DnsRepository(rawContext: Context) {
    private val context: Context = com.kernelpanic.baladdns.data.localization.localizedContext(rawContext)
    ...
    fun setDisableBehavior(value: com.kernelpanic.baladdns.data.dns.DnsDisableBehavior) {
    ...
    fun updateShortcuts() {
        ...
        val toggleShortcut = ShortcutInfo.Builder(context, shortcutId)
            ...
            .setIntent(Intent(context, MainActivity::class.java).apply {
                action = "com.kernelpanic.baladdns.TOGGLE_ACTION"
