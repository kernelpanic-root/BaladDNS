...
import com.kernelpanic.baladdns.data.runtime.RuntimeServicePlan
import com.kernelpanic.baladdns.data.runtime.deriveRuntimeServicePlan
import com.kernelpanic.baladdns.data.runtime.classifyRuntimeServiceFailure
...
class DnsRuntimeService : Service() {
    ...
    companion object {
        ...
        const val ACTION_SYNC = "com.kernelpanic.baladdns.action.SYNC_RUNTIME_MONITOR"
